...
- 使用其它不用REALITY的协议组合，如 [**VLESS-XTLS-Vision**](https://github.com/chika0801/Xray-examples/tree/main/VLESS-XTLS-Vision)。如果一定要用REALITY，使用 [**自己偷自己**](https://github.com/chika0801/Xray-examples/tree/main/VLESS-XTLS-uTLS-REALITY/steal_yourself) 方式
